...
export declare namespace ERCHandlerHelpers {
    type DecimalsStruct = {
        isSet: boolean;
        externalDecimals: BigNumberish;
    };
    type DecimalsStructOutput = [boolean, number] & {
        isSet: boolean;
...
export interface ERC20HandlerInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "defaultDecimals", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "defaultDecimals", data: BytesLike): Result;
...
export interface ERC20Handler extends BaseContract {
    ...
    functions: {
        ...
        _tokenContractAddressToTokenProperties(arg0: string, overrides?: CallOverrides): Promise<[
            ...
            boolean,
            boolean,
            ERCHandlerHelpers.DecimalsStructOutput
        ] & {
            resourceID: string;
            isWhitelisted: boolean;
            isBurnable: boolean;
            decimals: ERCHandlerHelpers.DecimalsStructOutput;
        }>;
        defaultDecimals(overrides?: CallOverrides): Promise<[number]>;
        /**
         * First verifies {contractAddress} is whitelisted, then sets {_tokenContractAddressToTokenProperties[contractAddress].isBurnable} to true.
        ...
        /**
         * Depending if the corresponding {tokenAddress} for the parsed {resourceID} is marked true in {_tokenContractAddressToTokenProperties[tokenAddress].isBurnable}, deposited tokens will be burned, if not, they will be locked.
         * A deposit is initiated by making a deposit in the Bridge contract.Data passed into the function should be constructed as follows: amount                                      uint256     bytes   0 - 32 destinationRecipientAddress     length      uint256     bytes  32 - 64 destinationRecipientAddress                 bytes       bytes  64 - END
