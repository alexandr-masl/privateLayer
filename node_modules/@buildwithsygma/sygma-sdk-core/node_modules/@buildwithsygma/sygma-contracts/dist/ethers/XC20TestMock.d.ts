...
export interface XC20TestMockInterface extends utils.Interface {
    contractName: "XC20TestMock";
    functions: {
...
export interface XC20TestMock extends BaseContract {
    contractName: "XC20TestMock";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: XC20TestMockInterface;
